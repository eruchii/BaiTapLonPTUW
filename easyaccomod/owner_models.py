...
class Room(db.Model):
	...
	city_code = db.Column(db.String(120), db.ForeignKey('city.code')) #lien ket voi bang city
...
class District(db.Model):
	city_code = db.Column(db.String(120), db.ForeignKey('city.code'))
...
class Ward(db.Model):
	city_code = db.Column(db.String(120), db.ForeignKey('city.code'))
	district_id = db.Column(db.String(120), db.ForeignKey('district.id'))
	id = db.Column(db.String(120), primary_key=True)
	name = db.Column(db.String(120))
	def __repr__(self):
